        ...
        <>
            ...
            <section className={`${styles["projects"]}`}>
                <article className={`${styles["article-project"]}`}>
                    ...
                    <p>Server-Side technologies: Express (NodeJS), Handlebars, MongoDB with mongoose, Bcrypt and ect.</p>
                    ...
                    <p>Server-side source code: <a href="https://github.com/Martin322s/healthy-food-app/tree/main/server" target="_blank">https://github.com/Martin322s/healthy-food-app/tree/main/server</a></p>
                </article>
                <article className={`${styles["article-project"]}`}>
                    ...
                    <p>Client-Side technologies: ReactJS, JavaScript, HTML, CSS</p>
                    <p>Server-Side technologies: Express (NodeJS), Handlebars, MongoDB with mongoose, Bcrypt and ect.</p>
                    <p>Client-side source code: <a href="https://github.com/MaRtin322s/film-library-project" target="_blank">https://github.com/MaRtin322s/film-library-project</a></p>
                    <p>Server-side source code: <a href="https://github.com/Martin322s/healthy-food-app/tree/main/server" target="_blank">https://github.com/Martin322s/healthy-food-app/tree/main/server</a></p>
                </article>
                <article className={`${styles["article-project"]}`}>
                    ...
                    <p>Client-Side technologies: ReactJS, JavaScript, HTML, CSS</p>
                    <p>Server-Side technologies: Express (NodeJS), Handlebars, MongoDB with mongoose, Bcrypt and ect.</p>
                    <p>Source code: <a href="https://github.com/Martin322s/softuni-shared-trips.git" target="_blank">https://github.com/Martin322s/softuni-shared-trips.git</a></p>
                </article>
            </section>
        </>
    );
